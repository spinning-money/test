...
export const MAINNET_ADDRESSES = {
  ...
  OLD_GAME_CONTRACT: "0x0340b156113539f6f6a82723ca8f79c283a8c1868ecb0b8b815d4491a38b51bc", // Old contract for data reading
...
export const OLD_GAME_CONTRACT_ADDRESS = CURRENT_NETWORK === NETWORKS.SEPOLIA ? SEPOLIA_ADDRESSES.GAME_CONTRACT : MAINNET_ADDRESSES.OLD_GAME_CONTRACT; // For data reading only
